        ...
        <div class="dashboard-row">
            ...
            <div class="dashboard-col content-box">
                <div class="section-header">
                    ...
                    <a href="/admin/minwon/list" class="btn btn-secondary btn-xs">더보기 +</a>
                </div>
            ...
            <div class="dashboard-col content-box">
                <div class="section-header">
                    ...
                    <a href="/admin/member/list" class="btn btn-secondary btn-xs">관리 이동 <i class="fa-solid fa-arrow-right"></i></a>
                </div>
                <table class="admin-table">
                    <colgroup>
