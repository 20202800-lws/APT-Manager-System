...
<body>
    ...
    <div class="find-wrapper">
        ...
        <div id="id-find" class="find-content active">
            ...
            <div id="id-result-area" class="result-box" style="display:none;">
                <p style="color:#666;">일치하는 아이디입니다.</p>
                <div class="result-id" id="display-id"></div>
                <div class="btn-area">
                    <a href="/member/login" class="btn-action" style="display:flex; align-items:center; justify-content:center; text-decoration:none;">로그인하기</a>
                </div>
            </div>
        </div>
        ...
        <div id="pw-find" class="find-content">
            ...
            <div id="pw-reset-step" style="display:none;">
