...
<body>
	...
	<section class="hero">
	    <div class="hero-slider">
			<a href="/intro/layout.jsp">
			  <img src="/images/logo/apart2.png"class="active" style="cursor: pointer;"></a>
		
			  	 <a href="/intro/layout.jsp">
			 <img src="/images/logo/apart4.png" style="cursor: pointer;"> </a>
    ...
    <section class="info-section" id="guide">
      ...
      <div class="image-container">
			    <a href="/intro/guide.jsp">
			        <img src="/images/logo/skyRounge.png"class="active" style="cursor: pointer;">
			    </a>
			    <a href="/intro/guide.jsp">
			        <img src="/images/logo/apart5.png" style="cursor: pointer;">
			    </a>
			    <a href="/intro/guide.jsp">
    ...
    <section class="info-section" id="plan">
		...
		<div class="image-container">
		    <a href="/intro/floor_plan.jsp">
		        <img src="/images/logo/84A.png" class="active" style="cursor: pointer;">
		    </a>
		    <a href="/intro/floor_plan.jsp">
		        <img src="/images/logo/84B.png" style="cursor: pointer;">
		    </a>
		    <a href="/intro/floor_plan.jsp">
		        <img src="/images/logo/84C.png" style="cursor: pointer;">
		    </a>
		</div>
    </section>
