			...
			<main class="content-area">
				...
				<div style="margin-top: 20px;">
					<div class="activity-header"
						...
						<span class="count-txt">총 <strong id="totalCount"
								style="color:var(--primary-color);">${myReplies != null ? myReplies.size() :
								0}</strong>건</span>
					</div>
						...
						<c:forEach var="reply" items="${myReplies}">
							<li class="list-item" style="border-bottom: 1px solid #eee; padding: 15px 0;">
								<div class="item-info" style="display:flex; flex-direction:column; gap:5px;">
									<span style="color:#999; font-size:12px;">원문: ${reply.board.title}</span>

									<a href="/board/detail?id=${reply.board.boardId}" class="subject"
										style="font-size: 16px; font-weight: bold;">${reply.content}</a>
