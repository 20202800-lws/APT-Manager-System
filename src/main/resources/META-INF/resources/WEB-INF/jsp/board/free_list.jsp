    ...
    <div class="container">
        <aside class="sidebar">
            ...
            <ul id="sideMenu">
                ...
                <li class="side-item" onclick="changeBoard('complaint', this)">민원게시판</li>
                ...
                <div id="talkWrapper" style="display:none;">
                    ...
                    <div class="quick-write-box">
                        ...
                        <div style="text-align:right;">
                            <button class="btn-main" onclick="saveQuickTalk()">등록하기</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="content-box">
                    <div class="detail-header" style="border-bottom:1px solid #eee; padding-bottom:15px;">
                        ...
                        <div style="color:#888; font-size:14px; margin-top:10px;">
                            작성자: <span id="viewuser_id" style="font-weight:700;"></span> | 
                            날짜: <span id="viewDate"></span> | 
                            조회수: <span id="viewHits"></span>
                        </div>
                    </div>
