...
<body>
    ...
    <div class="container">
        ...
        <main id="mainArea">
            <h3 style="font-size:24px; margin-bottom:20px; border-bottom:2px solid #1a0b2e; padding-bottom:15px;">새 게시글 작성</h3>
            
            <div class="content-box">
                <form action="<c:url value='/board/free/write'/>" method="post" enctype="multipart/form-data">
