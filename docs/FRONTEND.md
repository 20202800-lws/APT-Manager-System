...
│   ├── 📄 comp_list.jsp           (PGM-BRD-005)
│   ├── 📄 comp_proc.jsp           (PGM-BRD-006)
│   └── 📄 report_pop.jsp          (PGM-BRD-007)
│ 해결!
├── 📂 daycare (게시판 - 어린이집)
│   ├── 📄 notice_list.jsp         (PGM-KID-001)
│   ├── 📄 gallery_list.jsp        (PGM-KID-002)
│   ├── 📄 parent_list.jsp         (PGM-KID-003)
│   ├── 📄 write_form.jsp          (PGM-KID-004)
│   └── 📄 parent_write.jsp        (PGM-KID-005)
│  해결!
├── 📂 facility (커뮤니티 시설)
